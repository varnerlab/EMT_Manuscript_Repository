...
Several studies on ZEB signaling have modeled the role that microRNA can play in EMT, suggesting cell-fate determination is regulated by the miR-34/SNAIL and/or miR-200/ZEB mutual-inhibition feedback circuits \cite{Lu:2013aa,Zhang:2014aa,Tian:2013aa}.
...
However, these conclusions are likely sensitivity to the components that we have included in the model, and could also involve proteins that we have not considered.
...
In addition, other important regulatory proteins such as ZEB1 should be added to the next generation model.
...
Thus, ZEB1 can act in parallel to SNAIL and thus be an alternative to the canonical signaling paradigm presented here.
...
However, given that we do not have ZEB1 in our canonical architecture, this suggests multiple types of hybrid phenotypes could exist within the EMT program.
